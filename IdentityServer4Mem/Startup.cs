...
namespace IdentityServer4InMem
{
    public class Startup
    {
        ...
        {
            new ApiResource("api1", "My API #1") { UserClaims = { JwtClaimTypes.Name, JwtClaimTypes.WebSite } }
        ...
        private readonly List<Client> clients = new List<Client>
        {
            new Client
            {
                ...
                RedirectUris = new List<string> { "http://localhost:4200/dashboardComponent", "http://localhost:4200/silent-refresh.html"},
