...
project {
    ...
    buildType(MSpecSamples)
    buildType(MSpecTestProject)
    buildType(MSpecTests)
...
object MSpecSamples : BuildType({
    name = "MSpec Samples"

    vcs {
        root(HttpsGithubComAgrossMspecSamplesGitRefsHeadsMaster)
    }
...
object MSpecTests : BuildType({
    name = "MSpec Tests"

    vcs {
        root(HttpsGithubComBurkharttMspecTestGitRefsHeadsMaster)
    }
